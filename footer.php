 ...
 * ✅ FIX : balise </div> orpheline supprimée + label newsletter (Lighthouse)
 */
?>
</main><!-- #main -->
        ...
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <form class="footer-newsletter" action="#" method="post" onsubmit="return false;">
                    <label for="footer-newsletter-email" class="screen-reader-text" style="position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);border:0;">Votre adresse email</label>
                    <input type="email" id="footer-newsletter-email" name="email" placeholder="Votre adresse email" required>
                ...
                <a href="https://wa.me/<?php echo esc_attr( preg_replace( '/[^0-9]/', '', dsj_get_whatsapp() ) ); ?>"
                   ...
                   target="_blank"
                   rel="noopener noreferrer">
                    <span class="footer-whatsapp-icon" aria-hidden="true">&#128172;</span>
