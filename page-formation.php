...
<!-- ═══════════════════════════════════════════
     NOTRE AMBITION (citation inspirante)
     ═══════════════════════════════════════════ -->
<section class="formation-ambition-section section-padding" aria-labelledby="ambition-title">
    <div class="container">
        <div class="formation-ambition reveal-section">
            <span class="formation-ambition-icon"><?php echo $svg['target']; ?></span>
            <h2 id="ambition-title">Notre ambition</h2>
            <p>
