...
$hero_opacity = get_theme_mod('hero_apropos_opacity', '0.7');
...
<section class="page-header apropos-header" <?php if( $hero_image ) : ?>style="background-image: linear-gradient(rgba(0, 0, 0, <?php echo $hero_opacity; ?>), rgba(0, 0, 0, <?php echo $hero_opacity; ?>)), url('<?php echo esc_url( $hero_image ); ?>'); background-size: cover; background-position: center;"<?php endif; ?>>
    <div class="container">
            ...
            <div class="equipe-card">
                <div class="equipe-image">
                    <?php if ( get_theme_mod( 'equipe_1_image' ) ) : ?>
                        <img src="<?php echo esc_url( get_theme_mod( 'equipe_1_image' ) ); ?>" alt="<?php echo get_theme_mod( 'equipe_1_nom', 'Sœur Marie-Bernadette' ); ?>" class="equipe-photo">
                    <?php else : ?>
                        <div class="equipe-placeholder">🙏</div>
                    <?php endif; ?>
                </div>
                <h3><?php echo get_theme_mod( 'equipe_1_nom', 'Sœur Marie-Bernadette' ); ?></h3>
            ...
            <div class="equipe-card">
                <div class="equipe-image">
                    <?php if ( get_theme_mod( 'equipe_2_image' ) ) : ?>
                        <img src="<?php echo esc_url( get_theme_mod( 'equipe_2_image' ) ); ?>" alt="<?php echo get_theme_mod( 'equipe_2_nom', 'Sœur Thérèse' ); ?>" class="equipe-photo">
                    <?php else : ?>
                        <div class="equipe-placeholder">📚</div>
                    <?php endif; ?>
                </div>
                <h3><?php echo get_theme_mod( 'equipe_2_nom', 'Sœur Thérèse' ); ?></h3>
            ...
            <div class="equipe-card">
                <div class="equipe-image">
                    <?php if ( get_theme_mod( 'equipe_3_image' ) ) : ?>
                        <img src="<?php echo esc_url( get_theme_mod( 'equipe_3_image' ) ); ?>" alt="<?php echo get_theme_mod( 'equipe_3_nom', 'Sœur Claire' ); ?>" class="equipe-photo">
                    <?php else : ?>
                        <div class="equipe-placeholder">🏠</div>
                    <?php endif; ?>
                </div>
                <h3><?php echo get_theme_mod( 'equipe_3_nom', 'Sœur Claire' ); ?></h3>
