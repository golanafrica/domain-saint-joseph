...
🎛️ Options Customizer (Apparence > Personnaliser)
...
Guide rapide pour les sœurs
Action
Chemin WordPress
Fréquence
🖼️ Changer photo hero
...
Si rénovation
🖼️ Ajouter photo galerie
Galerie → Ajouter → Image + catégorie
Régulier
✏️ Modifier texte page
